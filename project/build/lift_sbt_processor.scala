...
class LiftSBTProcessor(info: ProjectInfo) extends ProcessorProject(info) {
  ...
  // val sbt_template_engine = "com.sidewayscoding" % "sbt_template_engine_2.7.7" % "0.2-SNAPSHOT"
  val sbt_template_engine = "com.sidewayscoding" % "sbt_template_engine_2.7.7" % "0.2-LOCAL"
